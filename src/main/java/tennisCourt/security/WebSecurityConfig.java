...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void get() {
        ...
        Users appUserClient1 = new Users("user", passwordEncoder().encode("user"), "ROLE_USER", client1);
        Users appUserClient2 = new Users("user1", passwordEncoder().encode("user1"), "ROLE_USER", client2);
        Users appUserClient3 = new Users("admin", passwordEncoder().encode("admin"), "ROLE_ADMIN", client3);
        ...
        Services services3 = new Services(LocalDate.now().plusDays(4), 1.0F, LocalTime.parse("11:00:00", DateTimeFormatter.ISO_TIME),
