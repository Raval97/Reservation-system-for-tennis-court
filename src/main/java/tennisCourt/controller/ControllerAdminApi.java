...
public class ControllerAdminApi {
    ...
    public String acceptApplication(@PathVariable(name = "id") Long id) {
        ...
        clubAssociationService.save(new ClubAssociation(LocalDate.now(), false, membershipApplication.getUsers()));
        Client client = clientService.getByUserId(membershipApplication.getUsers().getId());
